...
def beginner():
    ...
    def labelSlider():
        ...
        text = 'Welcome To Typing Speed Game In Beginner Level'
        if(count>=len(text)):
...
def intermediate():
    ...
    def labelSlider():
        global count,sliderWords
        text = 'Welcome To Typing Speed Game In Intermediate Level '
        if(count>=len(text)):
...
def advanced():
    ...
    def labelSlider():
        global count,sliderWords
        text = 'Welcome To Typing Speed Game In Advance Level'
        if(count>=len(text)):
